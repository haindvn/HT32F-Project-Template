...
#if (LIBCFG_PWM_8_CHANNEL)
#define TM_FLAG_CH4C        0x10000000ul  /*!< Channel 4 compare flag                                       */
#define TM_FLAG_CH5C        0x20000000ul  /*!< Channel 5 compare flag                                       */
#define TM_FLAG_CH6C        0x40000000ul  /*!< Channel 6 compare flag                                       */
#define TM_FLAG_CH7C        0x80000000ul  /*!< Channel 7 compare flag                                       */
#endif
 ...
 */
#define IS_TM(x)            (IS_GPTM0(x) || IS_GPTM1(x) || IS_MCTM0(x) || IS_PWM0(x) || IS_PWM1(x) || IS_PWM2(x))
...
#define IS_TM_OM_NOASYM (((x) == TM_OM_MATCH_NOCHANGE)  || \
                         ((x) == TM_OM_MATCH_INACTIVE)  || \
                         ((x) == TM_OM_MATCH_ACTIVE)    || \
                         ((x) == TM_OM_MATCH_TOGGLE)    || \
                         ((x) == TM_OM_PWM1)            || \
