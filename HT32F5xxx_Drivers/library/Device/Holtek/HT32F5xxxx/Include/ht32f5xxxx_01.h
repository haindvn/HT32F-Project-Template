...
typedef struct
{
  ...
  __IO uint32_t STR[15];         /*!< 0x070 - 0x0A8 ADC Input Sampling Time Register 0-7                    */
...
typedef struct
{
  ...
  #endif
  #if defined(USE_HT32F52344_54) || defined(USE_HT32F52357_67) || defined(USE_HT32F57342_52) || defined(USE_HT32F57331_41) || defined(USE_HT32F50343)
...
typedef struct
{
  ...
  #endif
  #if defined(USE_HT32F65232)
  __IO uint32_t OCR;             /*!< 0x014          Comparator Output Control Register                     */
  #endif
} HT_CMP_TypeDef;
...
typedef struct
{
  ...
  #if defined(USE_HT32F65232)
  __IO uint32_t OFR;             /*!< 0x004         Operational Amplifier Input Offset Register             */
  __IO uint32_t VALR;            /*!< 0x008         Operational Amplifier Voltage Reference Value Register  */
  #endif
} HT_OPA_TypeDef;
...
#if defined(USE_HT32F52231_41) || defined(USE_HT32F52331_41) || defined(USE_HT32F52243_53) || defined(USE_HT32F0006) || defined(USE_HT32F65230_40) || defined(USE_HT32F65232)
